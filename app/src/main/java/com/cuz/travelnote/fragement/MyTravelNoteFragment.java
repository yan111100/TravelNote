...
public class MyTravelNoteFragment extends LazyFragment {
    ...
    public class TravelNoteAdapter extends RecyclerView.Adapter<TravelNoteHolder> {
        ...
        public TravelNoteAdapter(List<TravelNote> travelNotess) {
            mTravelNotes = travelNotess;
        }
    ...
    void getData() {
        BaseClient.get("travelNote/myTravelNote", new Callback() {
            @Override
            public void onFailure(Call call, IOException e) {
                e.printStackTrace();
                Log.e("error", e.getMessage());
