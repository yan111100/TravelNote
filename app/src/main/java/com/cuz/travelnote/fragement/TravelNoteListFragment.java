...
public class TravelNoteListFragment extends LazyFragment {
    ...
    class TravelNoteHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(TravelNote travelNote) {
            ...
            introTextView.setTextSize(getActivity().getResources()
                    .getDimension(R.dimen.select_flow_textSize));
    ...
    void getData() {
        BaseClient.get("travelNote/all", new Callback() {
            @Override
            public void onFailure(Call call, IOException e) {
                e.printStackTrace();
                Log.e("error", e.getMessage());
