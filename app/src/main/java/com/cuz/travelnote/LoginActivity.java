...
public class LoginActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView registerTextView = findViewById(R.id.register_tx);
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case 0:    //登陆成功
                    ...
                    editor.commit();
                    Toast.makeText(LoginActivity.this, R.string.warning_login_success, Toast.LENGTH_SHORT).show();
                    finish();
                    break;
                case 1:    //登陆失败，账号或密码错误
                    String messageInfo = (String) msg.obj;
                    Toast.makeText(LoginActivity.this, messageInfo, Toast.LENGTH_SHORT).show();
                    break;
                case 2:    //登陆失败，链接服务器失败
                    Toast.makeText(LoginActivity.this, R.string.warning_login_failed, Toast.LENGTH_SHORT).show();
                    break;
                default:
                    break;
            }
